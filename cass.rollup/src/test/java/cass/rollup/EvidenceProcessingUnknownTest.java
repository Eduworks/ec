...
public class EvidenceProcessingUnknownTest
{
	EcRepository repo;
	String frameworkId;
	String competencyId;
	String competencyId2;
	String competencyId3;
	String assertionId;
	EcIdentity newId1;
	EcFramework f;
	EcCompetency c;
...
;
		...
		c3 = new EcCompetency();
      c3.addOwner(EcIdentityManager.ids.$get(0).ppk.toPk());
      c3.name = "Something else entirely";
      c3.generateId(repo.selectedServer);
      competencyId3 = c3.shortId();
		...
		c3.save(null, new Callback1<String>()
      {
         @Override
         public void $invoke(String p1)
         {

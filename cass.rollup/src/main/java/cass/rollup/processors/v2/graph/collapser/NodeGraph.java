...
public class NodeGraph {
	...
	public Array<NodeRelation> getRelationListForNode(Node n) {
	...
	public Array<Node> getNodeList() {
		return nodeList;
	}

	public void setNodeList(Array<Node> nodeList) {
		this.nodeList = nodeList;
	}

	public Array<NodeRelation> getRelationList() {
		return relationList;
	}

	public void setRelationList(Array<NodeRelation> relationList) {

 ...
 */
public class Assessment extends org.cassproject.schema.cass.competency.Competency
{
	 ...
	 * @type string
	 */
	public static String _subtype = "Assessment"; 
	public String subtype = Assessment._subtype;

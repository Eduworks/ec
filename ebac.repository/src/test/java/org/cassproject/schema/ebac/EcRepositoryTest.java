...
public class EcRepositoryTest
{
	...
	public void createPublicObjectTest()
	{
		...
		final EcRemoteLinkedData thing = new EcRemoteLinkedData(org.cassproject.schema.general.General.schema,
		...
		final EcRemoteLinkedData thing2 = new EcRemoteLinkedData(org.cassproject.schema.general.General.schema,
				org.cassproject.schema.general.General.schema+"/test");

 ...
 *
 * @param <FullJQuery>
 * 			Meaning that the foundation functions can be called on any JQueryCore instances 
...
public interface Foundation<FullJQuery extends JQueryCore<?>> {
	 ...
	 * 
	 * @return
	 * 			Returns the JQueryCore Instance so other JQuery functions could be called on it
	 */
	 ...
	 * 
	 * @param methodName
	 * 			Name of the foundation method to invoke
	 * @return
	 * 			Returns the JQueryCore Instance so other JQuery functions could be called on it
	 */

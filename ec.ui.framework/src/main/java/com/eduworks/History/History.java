...
public interface History<H extends org.stjs.javascript.History> {
	 ...
	 *
	 * @param obj   Any object that contains any state we want to remember for a history element (usually a history closure
	 *              object with a view that can be displayed)
	 * @param title Title of the History Element to be saved (not used)
	 * @param url   URL hash to display in the URL bar indicating which history element is being displayed
	 * @return Returns the history object so additional methods could be called on it
	 */
	 ...
	 *
	 * @param pos index to go in the browser's history
	 * @return Returns the history object so additional methods could be called on it
	 */
	 ...
	 *
	 * @return Integer representing how many items are in the browser's history
	 */
	public int length();

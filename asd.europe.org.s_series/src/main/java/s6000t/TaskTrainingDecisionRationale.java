...
public class TaskTrainingDecisionRationale extends EcRemoteLinkedData {
	...
	public TaskTrainingDecisionRationale() {
		super("http://www.asd-europe.org/s-series/s6000t", "TaskTrainingDecisionRationale");
	}

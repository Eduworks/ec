...
public class SubtaskTrainingLevelRationale extends EcRemoteLinkedData {
	...
	public SubtaskTrainingLevelRationale() {
		super("http://www.asd-europe.org/s-series/s3000l", "SubtaskTrainingLevelRationale");
	}

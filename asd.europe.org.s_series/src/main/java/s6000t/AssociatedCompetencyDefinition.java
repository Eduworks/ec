...
public class AssociatedCompetencyDefinition extends EcRemoteLinkedData {

    protected AssociatedCompetencyObligatoriness compType;
    protected CompetencyDefinitionRef compDef;
    ...
    public AssociatedCompetencyObligatoriness getCompType() {
        return compType;
    }

    public void setCompType(AssociatedCompetencyObligatoriness value) {
        this.compType = value;
    }

    public CompetencyDefinitionRef getCompDef() {
        return compDef;
    }

    public void setCompDef(CompetencyDefinitionRef value) {
        this.compDef = value;
    }
	...
	public AssociatedCompetencyDefinition() {
		super("http://www.asd-europe.org/s-series/s6000t", "AssociatedCompetencyDefinition");
	}

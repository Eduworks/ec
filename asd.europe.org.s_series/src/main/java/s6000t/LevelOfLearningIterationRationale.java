...
public class LevelOfLearningIterationRationale extends EcRemoteLinkedData {
	...
	public LevelOfLearningIterationRationale() {
		super("http://www.asd-europe.org/s-series/s6000t", "LevelOfLearningIterationRationale");
	}

...
/**
 * <p>Java class for subtaskByExternalReference complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="subtaskByExternalReference">
 *   &lt;complexContent>
 ...
 *         &lt;element name="docRef" type="{http://www.asd-europe.org/s-series/s3000l}documentReference" maxOccurs="unbounded"/>
...
@XmlType(name = "subtaskByExternalReference", namespace = "http://www.asd-europe.org/s-series/s3000l", propOrder = {
    "subtId",
    "subtRole",
    "name",
    "infoCode",
...
public class SubtaskByExternalReference {
    ...
    @XmlElement(nillable = true)
    protected List<SubtaskByExternalReference.AccParam> accParam;
    @XmlElements({
    ...
    @XmlElement(required = true)
    protected List<DocumentReference> docRef;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubtaskByExternalReference.AccParam }
     * 
     * 
     */
    public List<SubtaskByExternalReference.AccParam> getAccParam() {
        if (accParam == null) {
            accParam = new ArrayList<SubtaskByExternalReference.AccParam>();
        }
     ...
     * 
     */
    public List<DocumentReference> getDocRef() {
        if (docRef == null) {
            docRef = new ArrayList<DocumentReference>();
        }
        return this.docRef;
    }
     ...
     *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
     *       &lt;sequence>
     *         &lt;element name="paraDescr" type="{http://www.asd-europe.org/s-series/s3000l}subtaskAcceptanceParameterDescription" minOccurs="0"/>
     *         &lt;element name="paraValue" type="{http://www.asd-europe.org/s-series/s3000l}subtaskAcceptanceParameterValue" maxOccurs="unbounded" minOccurs="0"/>
     *         &lt;group ref="{http://www.asd-europe.org/s-series/s3000l}documentAssignmentItem"/>
     *         &lt;group ref="{http://www.asd-europe.org/s-series/s3000l}remarkAssignmentItem"/>
     *         &lt;group ref="{http://www.asd-europe.org/s-series/s3000l}applicabilityAssignmentItem"/>
     *       &lt;/sequence>
    ...
    public static class AccParam {
        ...
        @XmlElementRef(name = "paraDescr", type = JAXBElement.class, required = false)
        protected JAXBElement<SubtaskAcceptanceParameterDescription> paraDescr;
        @XmlElement(nillable = true)
        protected List<SubtaskAcceptanceParameterValue> paraValue;
        @XmlElementRef(name = "docs", type = JAXBElement.class, required = false)
        protected JAXBElement<s6000t.taskTrainAnalysis.ConditionInstance.Docs> docs;
        @XmlElementRef(name = "rmks", type = JAXBElement.class, required = false)
        protected JAXBElement<s6000t.taskTrainAnalysis.ConditionInstance.Rmks> rmks;
        ...
        /**
         * Gets the value of the paraDescr property.
         * 
         * @return
         *     possible object is
         *     {@link JAXBElement }{@code <}{@link SubtaskAcceptanceParameterDescription }{@code >}
         *     
         */
        public JAXBElement<SubtaskAcceptanceParameterDescription> getParaDescr() {
            return paraDescr;
        }

        /**
         * Sets the value of the paraDescr property.
         * 
         * @param value
         *     allowed object is
         *     {@link JAXBElement }{@code <}{@link SubtaskAcceptanceParameterDescription }{@code >}
         *     
         */
        public void setParaDescr(JAXBElement<SubtaskAcceptanceParameterDescription> value) {
         ...
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the paraValue property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getParaValue().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link SubtaskAcceptanceParameterValue }
         * 
         * 
         */
        public List<SubtaskAcceptanceParameterValue> getParaValue() {
            if (paraValue == null) {
                paraValue = new ArrayList<SubtaskAcceptanceParameterValue>();
            }

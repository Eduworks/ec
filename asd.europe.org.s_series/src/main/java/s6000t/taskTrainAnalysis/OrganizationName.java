 ...
 *         &lt;element name="providedBy" type="{http://www.asd-europe.org/s-series/s3000l}organizationReference" maxOccurs="0" minOccurs="0"/>
...
@XmlType(name = "organizationName", namespace = "http://www.asd-europe.org/s-series/s3000l", propOrder = {
    "descr",
    "lang",
    "date",
    "applic"

...
public class KeyPerformanceIndicatorStatus extends EcRemoteLinkedData {
	...
	public KeyPerformanceIndicatorStatus() {
		super("http://asd-europe.org/", "KeyPerformanceIndicatorStatus");
	}

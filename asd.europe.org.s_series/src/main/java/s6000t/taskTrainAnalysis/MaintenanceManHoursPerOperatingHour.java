...
public class MaintenanceManHoursPerOperatingHour extends EcRemoteLinkedData {
	...
	public MaintenanceManHoursPerOperatingHour() {
		super("http://asd-europe.org/", "MaintenanceManHoursPerOperatingHour");
	}

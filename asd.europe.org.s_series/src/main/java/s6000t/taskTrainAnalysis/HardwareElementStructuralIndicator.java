...
public class HardwareElementStructuralIndicator extends EcRemoteLinkedData {
	...
	public HardwareElementStructuralIndicator() {
		super("http://asd-europe.org/", "HardwareElementStructuralIndicator");
	}

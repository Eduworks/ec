...
public class OperatingLocationDescription extends EcRemoteLinkedData {
	...
	public OperatingLocationDescription() {
		super("http://asd-europe.org/", "OperatingLocationDescription");
	}

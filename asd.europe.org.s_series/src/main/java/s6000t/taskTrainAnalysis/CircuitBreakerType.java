...
/**
 * <p>Java class for circuitBreakerType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="code" type="{http://www.asd-europe.org/spec/validValues}circuitBreakerTypeCodeValues"/>
...
@XmlType(name = "circuitBreakerType", namespace = "http://www.asd-europe.org/s-series/s3000l", propOrder = {
    "code",
    "applic",
    "docs",
    "rmks"
...
public class CircuitBreakerType {
     ...
     * @return
     *     possible object is
     *     {@link CircuitBreakerTypeCodeValues }
     *     
     */

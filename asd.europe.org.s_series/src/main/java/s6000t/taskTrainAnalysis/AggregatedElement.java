...
/**
 * <p>Java class for aggregatedElement complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="aggregatedElement">
 *   &lt;complexContent>
 ...
 *         &lt;element name="beType" type="{http://www.asd-europe.org/s-series/s3000l}aggregatedElementType" minOccurs="0"/>
 *         &lt;element name="beRev" type="{http://www.asd-europe.org/s-series/s3000l}aggregatedElementRevision" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "aggregatedElement", namespace = "http://www.asd-europe.org/s-series/s3000l", propOrder = {
    "beId",
    "name",
    "esc",
    "beType",
...
public class AggregatedElement {
    ...
    protected JAXBElement<AggregatedElementType> beType;
    @XmlElement(nillable = true)
    protected List<AggregatedElementRevision> beRev;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AggregatedElementType }{@code >}
     *     
     */
    public JAXBElement<AggregatedElementType> getBeType() {
        return beType;
    }
     ...
     *     
     */
    public void setBeType(JAXBElement<AggregatedElementType> value) {
        this.beType = value;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AggregatedElementRevision }
     * 
     * 
     */
    public List<AggregatedElementRevision> getBeRev() {
        if (beRev == null) {
            beRev = new ArrayList<AggregatedElementRevision>();
        }
        return this.beRev;
    }

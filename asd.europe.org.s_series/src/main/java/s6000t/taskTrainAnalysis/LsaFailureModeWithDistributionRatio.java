...
public class LsaFailureModeWithDistributionRatio extends EcRemoteLinkedData {
    ...
    protected Array<LsaFailureModeDistributionRatio> distrRo;
    ...
    public Array<LsaFailureModeDistributionRatio> getDistrRo() {
        if (distrRo == null) {
            distrRo = new Array<LsaFailureModeDistributionRatio>();
        }
        return this.distrRo;
    }
	...
	public LsaFailureModeWithDistributionRatio() {
		super("http://asd-europe.org/", "LsaFailureModeWithDistributionRatio");
	}

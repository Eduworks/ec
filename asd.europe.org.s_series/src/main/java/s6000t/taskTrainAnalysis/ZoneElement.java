 ...
 *         &lt;element name="beType" type="{http://www.asd-europe.org/s-series/s3000l}zoneElementType" minOccurs="0"/>
 *         &lt;element name="beRev" type="{http://www.asd-europe.org/s-series/s3000l}zoneElementRevision" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "zoneElement", namespace = "http://www.asd-europe.org/s-series/s3000l", propOrder = {
    "beId",
    "name",
    "esc",
    "beType",
...
public class ZoneElement {
    ...
    protected JAXBElement<ZoneElementType> beType;
    @XmlElement(nillable = true)
    protected List<ZoneElementRevision> beRev;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ZoneElementType }{@code >}
     *     
     */
    public JAXBElement<ZoneElementType> getBeType() {
        return beType;
    }
     ...
     *     
     */
    public void setBeType(JAXBElement<ZoneElementType> value) {
        this.beType = value;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ZoneElementRevision }
     * 
     * 
     */
    public List<ZoneElementRevision> getBeRev() {
        if (beRev == null) {
            beRev = new ArrayList<ZoneElementRevision>();
        }
        return this.beRev;
    }

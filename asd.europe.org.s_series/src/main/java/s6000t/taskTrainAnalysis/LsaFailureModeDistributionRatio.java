...
public class LsaFailureModeDistributionRatio extends EcRemoteLinkedData {
	...
	public LsaFailureModeDistributionRatio() {
		super("http://asd-europe.org/", "LsaFailureModeDistributionRatio");
	}

 ...
 *         &lt;element name="class" type="{http://www.asd-europe.org/spec/validValues}contractIdentifierClassValues" minOccurs="0"/>
...
@XmlType(name = "contractIdentifier", namespace = "http://www.asd-europe.org/s-series/s3000l", propOrder = {
    "id",
    "clazz",
    "setBy"
})
public class ContractIdentifier {
    ...
    protected JAXBElement<ContractIdentifierClassValues> clazz;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ContractIdentifierClassValues }{@code >}
     *     
     */
    public JAXBElement<ContractIdentifierClassValues> getClazz() {
        return clazz;
    }
     ...
     *     
     */
    public void setClazz(JAXBElement<ContractIdentifierClassValues> value) {
        this.clazz = value;
    }

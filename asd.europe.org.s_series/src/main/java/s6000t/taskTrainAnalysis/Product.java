 ...
 *       &lt;sequence>
 *         &lt;element name="prodId" type="{http://www.asd-europe.org/s-series/s3000l}productIdentifier" maxOccurs="unbounded"/>
 *         &lt;element name="name" type="{http://www.asd-europe.org/s-series/s3000l}productName" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="prodVar" type="{http://www.asd-europe.org/s-series/s3000l}productVariant" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "product", namespace = "http://www.asd-europe.org/s-series/s3000l", propOrder = {
    "prodId",
    "name",
    "prodVar",
    "bkdns",
...
public class Product {
    ...
    protected List<ProductIdentifier> prodId;
    @XmlElement(nillable = true)
    protected List<ProductName> name;
    @XmlElement(nillable = true)
    protected List<ProductVariant> prodVar;
     ...
     * 
     */
    public List<ProductIdentifier> getProdId() {
        if (prodId == null) {
            prodId = new ArrayList<ProductIdentifier>();
        }
        return this.prodId;
    }
    ...
    public List<ProductName> getName() {
        if (name == null) {
            name = new ArrayList<ProductName>();
        }
        return this.name;
    }

    /**
     * Gets the value of the prodVar property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the prodVar property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getProdVar().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ProductVariant> getProdVar() {
        if (prodVar == null) {
            prodVar = new ArrayList<ProductVariant>();
        }
        return this.prodVar;
    }

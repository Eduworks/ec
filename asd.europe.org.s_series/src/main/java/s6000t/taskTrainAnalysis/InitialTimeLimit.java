...
/**
 * <p>Java class for initialTimeLimit complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="initialTimeLimit">
 *   &lt;complexContent>
...
@XmlType(name = "initialTimeLimit", namespace = "http://www.asd-europe.org/s-series/s3000l", propOrder = {
    "thld",
    "samplByDef",
    "samplByValue",
    "samplByRo"
})
public class InitialTimeLimit {

    @XmlElement(nillable = true)
    protected List<InitialTimeLimit.Thld> thld;
     ...
     * {@link InitialTimeLimit.Thld }
     * 
     * 
     */
    public List<InitialTimeLimit.Thld> getThld() {
        if (thld == null) {
            thld = new ArrayList<InitialTimeLimit.Thld>();
        }
        return this.thld;
    }

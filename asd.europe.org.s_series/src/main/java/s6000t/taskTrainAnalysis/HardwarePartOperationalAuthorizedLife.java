...
public class HardwarePartOperationalAuthorizedLife extends EcRemoteLinkedData {

    protected Array<HardwarePartOperationalAuthorizedLife.Aul> aul;
    ...
    public Array<HardwarePartOperationalAuthorizedLife.Aul> getAul() {
        if (aul == null) {
            aul = new Array<HardwarePartOperationalAuthorizedLife.Aul>();
        }
        return this.aul;
    }
	...
	public HardwarePartOperationalAuthorizedLife() {
		super("http://asd-europe.org/", "HardwarePartOperationalAuthorizedLife");
	}

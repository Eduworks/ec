...
public class FailureModeDetectionAbilityDescription extends EcRemoteLinkedData {
	...
	public FailureModeDetectionAbilityDescription() {
		super("http://asd-europe.org/", "FailureModeDetectionAbilityDescription");
	}

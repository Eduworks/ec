 ...
 *         &lt;element name="skillLevel" type="{http://www.asd-europe.org/s-series/s3000l}skillLevel" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "trade", namespace = "http://www.asd-europe.org/s-series/s3000l", propOrder = {
    "tradeName",
    "skillLevel",
    "orgInfos",
    "docs",
...
public class Trade {
    ...
    protected List<SkillLevel> skillLevel;
     ...
     * This is why there is not a <CODE>set</CODE> method for the skillLevel property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSkillLevel().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<SkillLevel> getSkillLevel() {
        if (skillLevel == null) {
            skillLevel = new ArrayList<SkillLevel>();
        }

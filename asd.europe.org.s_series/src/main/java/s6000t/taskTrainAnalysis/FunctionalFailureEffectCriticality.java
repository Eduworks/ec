...
public class FunctionalFailureEffectCriticality extends EcRemoteLinkedData {
	...
	public FunctionalFailureEffectCriticality() {
		super("http://asd-europe.org/", "FunctionalFailureEffectCriticality");
	}

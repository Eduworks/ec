 ...
 *       &lt;sequence>
 *         &lt;element name="code" type="{http://www.asd-europe.org/spec/validValues}softwareTypeCodeValues"/>
...
@XmlType(name = "softwareType", namespace = "http://www.asd-europe.org/s-series/s3000l", propOrder = {
    "code",
    "applic",
    "docs",
    "rmks"
...
public class SoftwareType {
    ...
    protected SoftwareTypeCodeValues code;
     ...
     * @return
     *     possible object is
     *     {@link SoftwareTypeCodeValues }
     *     
     */
    public SoftwareTypeCodeValues getCode() {
        return code;
    }
     ...
     *     
     */
    public void setCode(SoftwareTypeCodeValues value) {
        this.code = value;
    }

...
public class TaskMaterialResourceByReference extends EcRemoteLinkedData {
	...
	public TaskMaterialResourceByReference() {
		super("http://asd-europe.org/", "TaskMaterialResourceByReference");
	}

 ...
 *       &lt;sequence>
 *         &lt;element name="code" type="{http://www.asd-europe.org/spec/validValues}remarkTypeCodeValues"/>
...
@XmlType(name = "remarkType", namespace = "http://www.asd-europe.org/s-series/s3000l", propOrder = {
    "code",
    "applic",
    "docs",
    "rmks"
...
public class RemarkType {
    ...
    protected RemarkTypeCodeValues code;
     ...
     * @return
     *     possible object is
     *     {@link RemarkTypeCodeValues }
     *     
     */
    public RemarkTypeCodeValues getCode() {
        return code;
    }
     ...
     *     
     */
    public void setCode(RemarkTypeCodeValues value) {
        this.code = value;
    }

...
/**
 * <p>Java class for hardwareElement complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="hardwareElement">
 *   &lt;complexContent>
 ...
 *         &lt;element name="beType" type="{http://www.asd-europe.org/s-series/s3000l}hardwareElementType" minOccurs="0"/>
 *         &lt;element name="beRev" type="{http://www.asd-europe.org/s-series/s3000l}hardwareElementRevision" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "hardwareElement", namespace = "http://www.asd-europe.org/s-series/s3000l", propOrder = {
    "beId",
    "name",
    "esc",
    "beType",
...
public class HardwareElement {
    ...
    protected JAXBElement<HardwareElementType> beType;
    @XmlElement(nillable = true)
    protected List<HardwareElementRevision> beRev;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link HardwareElementType }{@code >}
     *     
     */
    public JAXBElement<HardwareElementType> getBeType() {
        return beType;
    }
     ...
     *     
     */
    public void setBeType(JAXBElement<HardwareElementType> value) {
        this.beType = value;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link HardwareElementRevision }
     * 
     * 
     */
    public List<HardwareElementRevision> getBeRev() {
        if (beRev == null) {
            beRev = new ArrayList<HardwareElementRevision>();
        }
        return this.beRev;
    }

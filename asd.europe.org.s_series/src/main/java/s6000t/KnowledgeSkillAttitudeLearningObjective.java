...
public class KnowledgeSkillAttitudeLearningObjective extends EcRemoteLinkedData {

    protected Array<KnowledgeSkillAttitudeLearningObjectiveRationale> loRtnle;
    ...
    public Array<KnowledgeSkillAttitudeLearningObjectiveRationale> getLoRtnle() {
        if (loRtnle == null) {
            loRtnle = new Array<KnowledgeSkillAttitudeLearningObjectiveRationale>();
        }
        return this.loRtnle;
    }
	...
	public KnowledgeSkillAttitudeLearningObjective() {

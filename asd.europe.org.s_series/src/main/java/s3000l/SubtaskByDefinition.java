...
public class SubtaskByDefinition extends EcRemoteLinkedData {
    ...
    protected Array<s3000l.SubtaskByExternalReference.AccParam> accParam;
    ...
    public Array<s3000l.SubtaskByExternalReference.AccParam> getAccParam() {
        if (accParam == null) {
            accParam = new Array<s3000l.SubtaskByExternalReference.AccParam>();
        }
	...
	public SubtaskByDefinition() {
		super("http://www.asd-europe.org/s-series/s3000l", "SubtaskByDefinition");
	}

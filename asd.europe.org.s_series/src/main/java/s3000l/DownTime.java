...
public class DownTime extends EcRemoteLinkedData {
    ...
    public static class OrgInfos {
        ...
        protected Array<OrganizationAssignment> orgInfo;

        public Array<OrganizationAssignment> getOrgInfo() {
            if (orgInfo == null) {
                orgInfo = new Array<OrganizationAssignment>();
            }
            return this.orgInfo;
        }
	...
	public DownTime() {
		super("http://www.asd-europe.org/s-series/s3000l", "DownTime");
	}

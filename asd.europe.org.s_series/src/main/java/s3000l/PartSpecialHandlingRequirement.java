...
public class PartSpecialHandlingRequirement extends EcRemoteLinkedData {
	...
	public PartSpecialHandlingRequirement() {
		super("http://www.asd-europe.org/s-series/s3000l", "PartSpecialHandlingRequirement");
	}

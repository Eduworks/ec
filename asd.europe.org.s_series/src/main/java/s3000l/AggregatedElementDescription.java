...
public class AggregatedElementDescription extends EcRemoteLinkedData {
	...
	public AggregatedElementDescription() {
		super("http://www.asd-europe.org/s-series/s3000l", "AggregatedElementDescription");
	}

...
public class HardwarePartHazardousClass extends EcRemoteLinkedData {
	...
	public HardwarePartHazardousClass() {
		super("http://www.asd-europe.org/s-series/s3000l", "HardwarePartHazardousClass");
	}

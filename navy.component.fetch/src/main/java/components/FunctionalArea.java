...
public class FunctionalArea extends NavyComponent {

    private static final String DC_TERMS_TYPE = "Functional Area";

    private JSONArray occupationalTaskIds  = new JSONArray();

    public FunctionalArea(String externalSystemId, String externalShortId, String name, String description, String code) {

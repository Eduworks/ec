...
public class DodOccupation extends NavyComponent {

    private static final String DC_TERMS_TYPE = "DOD Occupation";

    private JSONArray ratingIds  = new JSONArray();

    public DodOccupation(String externalSystemId, String externalShortId, String name, String description, String code) {

...
public class Ability extends NavyComponent {

    private static final String DC_TERMS_TYPE = "Ability";

    public Ability(String externalSystemId, String externalShortId, String name, String description, String code) {

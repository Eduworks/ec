...
$('#index').load('https://docs.google.com/a/eduworks.com/document/d/1whvPXVSDZ-AaG5dPllEkxj1dOZKkDV29kdbyOtHjRyo/pub?embedded=true', null, function () {
    $("style").remove();
    $("a").each(function () {
...
if (QueryString["doc"] == null)
    QueryString["doc"] = "1aL4a-JMnwkI4a2dfRwcJzA-3fLhEmGx6Xta4rIZG_yw";

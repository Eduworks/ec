...
public class EcCompetencyTest {
    ...
    public void createCompetencyTest() {
        ...
        JSObjectAdapter.$put(paramObj, "size", 5000);
        repo.searchWithParams(new EcCompetency().getSearchStringByType(), paramObj, null, new Callback1<Array<EcRemoteLinkedData>>() {
            @Override

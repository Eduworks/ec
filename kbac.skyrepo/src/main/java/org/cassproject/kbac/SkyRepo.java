...
import static org.cassproject.kbac.levr.urlBase;
...
public class SkyRepo {
	...
	public static Function0<Array<EbacSignature>> signatureSheet = new Function0<Array<EbacSignature>>() {
		...
		public Array<EbacSignature> $invoke() {
			...
			for (int i = 0; i < sigSheet.$length(); i++) {
				...
				String type = getTypeFromObject(signature);
				if (type == null)
		...
		public Object $invoke(Object o) {
			...
			if (EcObject.isObject(o)) {
				...
				for (int i = 0; i < ary.$length(); i++)
					ary.$set(i, JSFunctionAdapter.call(filterResults, this, ary.$get(i), null));
				return ary;
			} else
				return o;
		}
	...
	public static String skyrepoPutInternalPermanent(Object o, String id, String version, String type) {
		if (permanentCreated == false)
		{
			Object permNoIndex = new Object();
			Object doc = new Object();
			JSObjectAdapter.$put(permNoIndex,"_doc",doc);
			JSObjectAdapter.$put(doc,"enabled",false);

			Global.console.log(Global.JSON.stringify(levr.httpPut(permNoIndex,urlBase() +"/permanent")));
	...
	public static Object skyrepoGetIndexInternal(String index, String id, String version, String type) {
		return Global.JSON.parse(levr.httpGet(getUrl(index, id, version, type)));
	}
	...
	public static Object skyrepoGetPermanent(String id, String version, String type) {
		//TODO: Fetch from permanent location.
		return null;
	}
	...
	public static Function3<String, String, String, Object> skyrepoGetInternal = new Function3<String, String, String, Object>() {
		...
		public Object $invoke(String id, String version, String type) {
			if (version == null)
				version = (String) JSObjectAdapter.$get(JSFunctionAdapter.call(skyrepoGetIndex, this, id, version, type, null), "_version");
			//TODO: Validate inputs
			Object permanent = skyrepoGetPermanent(id, version, type);
			if (permanent != null)
				return permanent;

			Global.console.log("Failed to find " + id + "/" + version + "/" + type + " -- getting degraded form from search index.");
			return JSObjectAdapter.$get(JSFunctionAdapter.call(skyrepoGetIndex, this, id, version, type, null), "_source");
		}
	};

	public static Function3<String, String, String, Object> skyrepoGet = new Function3<String, String, String, Object>() {
		@Override
		public Object $invoke(String id, String version, String type) {
...
//			levr.error("Data does not validate. Only validatable data can be saved.",401);
	...
	private static Callback4<String, String, String, String> validateSignatures = new Callback4<String, String, String, String>() {
		...
		public void $invoke(String id, String version, String type, String errorMessage) {
			...
			oldObj.copyFrom(JSFunctionAdapter.call(skyrepoGet, this, id, version, type, null));
	...
	public static Function6<String, String, Integer, Integer, String, String, Array> skyrepoSearch = new Function6<String, String, Integer, Integer, String, String, Array>() {
		...
		public Array $invoke(String q, String urlRemainder, Integer start, Integer size, String sort, String track_scores) {
			...
			for (int i = 0; i < searchResults.$length(); i++) {
				...
				searchResults.$set(i, skyrepoGetPermanent(id, version, type));
			}
	...
	public static Object queryParse(String urlRemainder) {
		if (urlRemainder == null)
		...
		if (split.$length() >= 3)
			JSObjectAdapter.$put(result, "type", split.$get(2));
		if (split.$length() == 4)
			JSObjectAdapter.$put(result, "version", split.$get(3));
		return result;
	}

	public static Function2<Object, Boolean, Object> tryFormatOutput = new Function2<Object, Boolean, Object>() {
		@Override
		public Object $invoke(Object o, Boolean expand) {
			Object hdrs = JSFunctionAdapter.call(levr.headers, this);
